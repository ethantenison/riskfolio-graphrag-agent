...
poetry run riskfolio-agent eval --output benchmarks/eval_results.json
poetry run riskfolio-agent eval-gate --report benchmarks/eval_results.json
...
echo "Expected outputs: benchmarks/eval_results.json, benchmarks/retrieval_ablation_results.json, artifacts/observability/sli_report.json"
